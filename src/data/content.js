...
(function () {
  ...
  const BUILDINGS = {
    ...
    water_pump: { id: 'water_pump', name: '抽水站', shortName: '抽水站', icon: '💧', color: '#599bc0', kind: 'miner', family: null, tier: 1, w: 80, h: 80, speed: 1, powerDemandKw: 300, powerGenerationKw: 0, inputCapacity: 0, outputCapacity: 300, techId: 'fluid_handling', mineItems: ['water', 'sulfuric_acid', 'hydrogen'], description: '部署在水源边抽取水与酸液，化工产线的起点。' },
